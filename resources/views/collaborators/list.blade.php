                  ...
                  <div class="grid grid-cols-6 gap-6">
                     ...
                     <div class="col-span-6 sm:col-span-4">
                        <div class="flex">
                           ...
                           <label class="block font-medium text-sm text-gray-700" for="enroll">
                              Matrícula
                           </label>
                        </div>
                        <div class="flex">
                           ...
                           <input class="ml-2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="enroll" type="text">
                        </div>
                     </div>
