        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:-my-px sm:ml-5 sm:flex">
                    ...
                    <x-jet-nav-link class="ml-1" style='display:none' href="{{ route('medicalschedules.list') }}" :active="request()->routeIs('medicalschedules.list')">
                        {{ __('Agendamentos') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link class="ml-1" style='display:none' href="{{ route('attendances.list') }}" :active="request()->routeIs('attendances.list')">
                        {{ __('Atendimentos') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link class="ml-1" style='display:none' href="#">
                        {{ __('Relatórios') }}
                    </x-jet-nav-link>
